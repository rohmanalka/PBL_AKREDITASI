...
class KriteriaLimaController extends Controller
{
    public function index()
    {
        ...
        $breadcrumb = (object) [
            'title' => __('kriteria.kriteria.5.title',  ['username' => $username]),
    ...
    public function create()
    {
        ...
        $breadcrumb = (object) [
            'title' => __('kriteria.kriteria.5.titleinpt',  ['username' => $username]),
    ...
    public function edit($id)
    {
        ...
        $breadcrumb = (object) [
            'title' => __('kriteria.kriteria.5.titleedit',  ['username' => $username]),
            'list' => __('kriteria.kriteria.5.listedit')
        ];
    ...
    public function show(string $id)
    {
        ...
        return view('kriteria5.show', ['details' => $details, 'id' => $id]);
    }
    ...
    {
        $details = DetailKriteriaModel::with('kriteria')->find($id);
        return view('kriteria5.confirm', ['details' => $details, 'id' => $id]);
    }
