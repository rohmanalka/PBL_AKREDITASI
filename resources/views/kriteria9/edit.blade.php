                ...
                <div class="card mb-4">
                    ...
                    <form id="formPPEPP" enctype="multipart/form-data">
                        ...
                        <div class="row mx-1 mt-3 border-bottom pb-3">
                            <div class="col-md-9">
                                <h6 class="font-weight-bold">1. {{ __('penetapan') }}</h6>
                                ...
                                <div class="card">
                                    <div class="card-body text-center">
                                        <label class="btn btn-outline-primary btn-sm mb-2" for="input-penetapan">
                                            <i class="fas fa-upload"></i> {{ __('upload_gambar') }}
                                        </label>
                        ...
                        <div class="row mx-1 mt-3 border-bottom pb-3">
                            <div class="col-md-9">
                                <h6 class="font-weight-bold">2. {{ __('pelaksanaan') }}</h6>
                        ...
                        <div class="row mx-1 mt-3 border-bottom pb-3">
                            <div class="col-md-9">
                                <h6 class="font-weight-bold">3. {{ __('evaluasi') }}</h6>
                        ...
                        <div class="row mx-1 mt-3 border-bottom pb-3">
                            <div class="col-md-9">
                                <h6 class="font-weight-bold">4. {{ __('pengendalian') }}</h6>
                        ...
                        <div class="row mx-1 mt-3 pb-3">
                            <div class="col-md-9">
                                <h6 class="font-weight-bold">5. {{ __('peningkatan') }}</h6>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <button type="reset" class="btn btn-outline-secondary me-2" onclick="resetForm()">
                                        <i class="fas fa-undo-alt me-1"></i> {{ __('reset') }}
                                    </button>
                                    <a href="{{ url('kriteria9/') }}" class="btn btn-outline-danger">
                                ...
                                <div>
                                    ...
                                    <button type="button" class="btn btn-primary" id="submitBtn"
                                        ...
                                        <i class="fas fa-paper-plane me-1"></i> {{ __('submit') }}
                                    </button>
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <script type='text/javascript'>
        ...
        function submitForm(status) {
            ...
            fetch("{{ url('kriteria9/' . $detail->id_detail_kriteria . '/update') }}", {
                    method: "POST",
                    headers: {
                        'X-CSRF-TOKEN': "{{ csrf_token() }}",
                        'Accept': 'application/json',
                ...
                .then(data => {
                    if (data.status) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ url('kriteria9') }}";
                        });
                    } else {
