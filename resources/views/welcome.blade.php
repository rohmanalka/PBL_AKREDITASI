            ...
            <div class="swiper-wrapper">
                    ...
                    <div>
                        <div
                            ...
                            <div class="full-background bg-cover"
                                style="background-image: url('{{ asset('corporate/assets/img/img-2.jpg') }}')">
                            </div>
                ...
                <div class="swiper-slide">
                    <div
                        class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                        <div class="full-background bg-cover"
                            style="background-image: url('{{ asset('corporate/assets/img/img-1.jpg') }}')">
                        </div>
                        <div class="card-body text-start px-3 py-0 w-100">
                            <div class="row mt-12">
                                <div class="col-sm-3 mt-auto">
                ...
                <div class="swiper-slide">
                    <div
                        class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                        <div class="full-background bg-cover"
                            style="background-image: url('{{ asset('corporate/assets/img/img-3.jpg') }}')">
                        </div>
                        <div class="card-body text-start px-3 py-0 w-100">
                            <div class="row mt-12">
                                <div class="col-sm-3 mt-auto">
                ...
                <div class="swiper-slide">
                    <div
                        class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                        <div class="full-background bg-cover"
                            style="background-image: url('{{ asset('corporate/assets/img/img-4.jpg') }}')">
                        </div>
                        <div class="card-body text-start px-3 py-0 w-100">
                            <div class="row mt-12">
                                <div class="col-sm-3 mt-auto">
                ...
                <div class="swiper-slide">
                    <div
                        class="card card-background shadow-none border-radius-xl card-background-after-none align-items-start mb-0">
                        <div class="full-background bg-cover"
                            style="background-image: url('{{ asset('corporate/assets/img/img-5.jpg') }}')">
                        </div>
                        <div class="card-body text-start px-3 py-0 w-100">
                            <div class="row mt-12">
                                <div class="col-sm-3 mt-auto">
