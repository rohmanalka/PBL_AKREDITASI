...
class KriteriaSatuController extends Controller
{
    public function index()
    {
        ...
        $breadcrumb = (object) [
            'title' => __('kriteria.kriteria.1.title',  ['username' => $username]),
    ...
    public function create()
    {
        ...
        $breadcrumb = (object) [
            'title' => __('kriteria.kriteria.1.titleinpt',  ['username' => $username]),
    ...
    public function edit($id)
    {
        ...
        $breadcrumb = (object) [
            'title' => __('kriteria.kriteria.1.titleedit',  ['username' => $username]),
            'list' => __('kriteria.kriteria.1.listedit')
        ];
    ...
    public function show(string $id)
    {
        ...
        return view('kriteria1.show', ['details' => $details, 'id' => $id]);
    }
    ...
    {
        $details = DetailKriteriaModel::with('kriteria')->find($id);
        return view('kriteria1.confirm', ['details' => $details, 'id' => $id]);
    }
