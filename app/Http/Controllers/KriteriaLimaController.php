...
class KriteriaLimaController extends Controller
{
    public function index()
    {
        ...
        $page = (object) [
            'title' => ('Criterion 5 - SIB Polinema'),
        ];
    ...
    public function create()
    {
        ...
        return view(view: 'kriteria5.input', data: [
            'breadcrumb' => $breadcrumb,
            'page' => $page,
            'activeMenu' => $activeMenu,
            'activeSubmenu' => $activeSubmenu
    ...
    public function edit($id)
    {
        ...
        $page = (object) [
            'title' => 'Edit Kriteria 5 - Statuta Polinema',
        ];
    ...
    public function show(string $id)
    {
        ...
        return view('kriteria5.show', ['breadcrumb' => $breadcrumb, 'page' => $page, 'details' => $details, 'id' => $id]);
    }
    ...
    public function preview($id)
    {
        ...
        $pdf = Pdf::loadView('kriteria5.export', compact('details'));
    ...
    public function confirm(string $id)
    {
        ...
        return view('kriteria5.confirm', ['breadcrumb' => $breadcrumb, 'page' => $page, 'details' => $details, 'id' => $id]);
    }
