                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <a href="{{ url('kriteria4/') }}" class="btn btn-outline-danger">
...
@section('script')
    ...
    <script type='text/javascript'>
        ...
        function submitForm(status) {
            ...
            fetch("{{ url('kriteria4/' . $detail->id_detail_kriteria . '/update') }}", {
                    method: "POST",
                    headers: {
                        'X-CSRF-TOKEN': "{{ csrf_token() }}",
                        'Accept': 'application/json',
                ...
                .then(data => {
                    if (data.status) {
                        Swal.fire({
                            ...
                            window.location.href = "{{ url('kriteria4') }}";
                        });
                    } else {
