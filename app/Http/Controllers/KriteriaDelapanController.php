...
class KriteriaDelapanController extends Controller
{
    public function index()
    {
        ...
        $breadcrumb = (object) [
            'title' => __('kriteria.kriteria.8.title',  ['username' => $username]),
            'list' => __('kriteria.kriteria.8.list')
        ];

        $page = (object) [
            'title' => __('kriteria.kriteria.8.page'),
        ];
    ...
    public function create()
    {
        ...
        $breadcrumb = (object) [
            'title' => __('kriteria.kriteria.8.titleinpt',  ['username' => $username]),
            'list' => __('kriteria.kriteria.8.listinpt')
        ];

        $page = (object) [
            'title' => __('kriteria.kriteria.8.pageinpt'),
        ];
    ...
    public function edit($id)
    {
        ...
        $breadcrumb = (object) [
            'title' => __('kriteria.kriteria.8.titleedit',  ['username' => $username]),
            'list' => __('kriteria.kriteria.8.listedit')
        ];

        $page = (object) [
            'title' =>  __('kriteria.kriteria.8.pageedit'),
        ];

        $activeMenu = 'riwayat8';

        return view('kriteria8.edit', [
            'breadcrumb' => $breadcrumb,
            'page' => $page,
            'activeMenu' => $activeMenu,
            'detail' => $detail,
    ...
    public function show(string $id)
    {
        ...
        return view('kriteria8.show', ['details' => $details, 'id' => $id]);
    }
    ...
    public function preview($id)
    {
        ...
        $pdf = Pdf::loadView('kriteria8.export', compact('details'));
    ...
    {
        $details = DetailKriteriaModel::with('kriteria')->find($id);
        return view('kriteria8.confirm', ['details' => $details, 'id' => $id]);
    }
