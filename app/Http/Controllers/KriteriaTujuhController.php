...
class KriteriaTujuhController extends Controller
{
    ...
    {
        $breadcrumb = (object) [
            'title' => ('Criteration Seven'),
            'list' => ['Criteration', 'Criteration7'],
        ];

        $page = (object) [
            'title' => ('Criteration 7 - SIB Polinema'),
        ];
    ...
    public function show(string $id)
    {
        ...
        return view('kriteria7.show', ['breadcrumb' => $breadcrumb, 'page' => $page, 'details' => $details, 'id' => $id]);
    }
    ...
    public function confirm(string $id)
    {
        ...
        return view('kriteria7.confirm', ['breadcrumb' => $breadcrumb, 'page' => $page, 'details' => $details, 'id' => $id]);
    }
