...
class KriteriaDelapanController extends Controller
{
    ...
    public function create()
    {
        ...
        $breadcrumb = (object) [
            'title' => ('messages.krit8_title'),
            'list' => ['messages.krit8_list']
        ];
    ...
    public function show(string $id)
    {
        ...
        return view('kriteria8.show', ['breadcrumb' => $breadcrumb, 'page' => $page, 'details' => $details, 'id' => $id]);
    }
    ...
    public function confirm(string $id)
    {
        ...
        return view('kriteria8.confirm', ['breadcrumb' => $breadcrumb, 'page' => $page, 'details' => $details, 'id' => $id]);
    }
