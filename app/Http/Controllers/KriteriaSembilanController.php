...
class KriteriaSembilanController extends Controller
{
    public function index()
    {
        ...
        $breadcrumb = (object) [
            'title' => __('kriteria.kriteria.9.title',  ['username' => $username]),
            'list' => __('kriteria.kriteria.9.list')
        ];

        $page = (object) [
            'title' => __('kriteria.kriteria.9.page'),
        ];
    ...
    public function create()
    {
        ...
        $breadcrumb = (object) [
            'title' => __('kriteria.kriteria.9.titleinpt',  ['username' => $username]),
            'list' => __('kriteria.kriteria.9.listinpt')
        ];

        $page = (object) [
            'title' => __('kriteria.kriteria.9.pageinpt'),
        ];
    ...
    public function edit($id)
    {
        ...
        $breadcrumb = (object) [
            'title' => __('kriteria.kriteria.9.titleedit',  ['username' => $username]),
            'list' => __('kriteria.kriteria.9.listedit')
        ];

        $page = (object) [
            'title' =>  __('kriteria.kriteria.9.pageedit'),
        ];
    ...
    public function show(string $id)
    {
        ...
        return view('kriteria9.show', ['details' => $details, 'id' => $id]);
    }
    ...
    public function preview($id)
    {
        ...
        $pdf = Pdf::loadView('kriteria9.export', compact('details'));
    ...
    {
        $details = DetailKriteriaModel::with('kriteria')->find($id);
        return view('kriteria9.confirm', ['details' => $details, 'id' => $id]);
    }
