...
@else
    <form action="{{ url('/kriteria2/' . $details->id_detail_kriteria . '/delete') }}" method="POST" id="form-delete">
        @csrf
        @method('DELETE')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <div>
                                <iframe src="{{ url('/kriteria2/preview/' . $id) }}" width="100%" height="400px"
                ...
                <div class="modal-footer">
                    <button type="button" data-dismiss="modal"
                        class="btn btn-warning">{{ __('kriteria.cancel') }}</button>
